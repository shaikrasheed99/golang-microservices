...
func TestBrokerHandler_Handle_AuthSignup(t *testing.T) {
...
func TestBrokerHandler_Handle_AuthLogin(t *testing.T) {
	req := &requests.RequestPayload{
		Action: constants.AuthLoginAction,
		Login: requests.AuthLoginPayload{
			Username: "test",
			Password: "test",
		},
	}
	...
	t.Run("should be able to handle auth login api", func(t *testing.T) {
		mockService := new(mocks.IBrokerService)
		mockService.On("HandleAuthLogin", &req.Login).Return(serviceRes, nil)
	...
	t.Run("should be able to handle auth login api when error from the auth service", func(t *testing.T) {
		serviceError := errors.New("error from auth service")
		mockService := new(mocks.IBrokerService)
		mockService.On("HandleAuthLogin", &req.Login).Return("", serviceError)
